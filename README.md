...
In summary, writeBedGraph.run mapReduce --> writeBedGraph_wrapper --> writeBedGraph_worker --> CountReadsPerBin.count_reads_in_region
...
Define the scaling factor by adding the `--scaleFactor`. Only the reads.2.txt file is neded for this method.
